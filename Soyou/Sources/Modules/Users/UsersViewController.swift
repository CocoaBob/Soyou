...
class UsersViewController: UIViewController {
    ...
    class func instantiate() -> UsersViewController {
        return  UIStoryboard(name: "UsersViewController", bundle: nil).instantiateViewController(withIdentifier: "UsersViewController") as! UsersViewController
    }
...
extension UsersViewController: UISearchControllerDelegate {
    ...
    func setupRightBarButtonItem() {
        self.navigationItem.rightBarButtonItem = UIBarButtonItem(barButtonSystemItem: .search, target: self, action: #selector(UsersViewController.showSearchController))
    }
    ...
    func setupSearchController() {
        let searchResultsController = UsersViewController.instantiate()
